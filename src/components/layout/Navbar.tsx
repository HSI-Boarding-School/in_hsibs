...
function Avatar({ user }: { user: Session }) {
  ...
  return (
    <span className="inline-flex h-9 w-9 items-center justify-center rounded-full bg-primary-dark text-sm font-black text-white ring-2 ring-white">
    ...
    <header className="flex items-center justify-between gap-4 rounded-sm border border-white/80 bg-surface/80 px-5 py-3 shadow-[0_14px_40px_rgba(39,49,38,0.08)] backdrop-blur-sm">
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="relative flex h-11 w-11 items-center justify-center rounded-lg border border-border bg-surface-strong text-muted transition-colors hover:border-primary/30 hover:text-primary-dark"
        >
        ...
        <div className="relative">
          <button
            type="button"
            aria-label="Profil"
            className="flex items-center gap-2 rounded-lg border border-border bg-surface-strong px-2 py-1.5 transition-colors hover:border-primary/30"
          ...
          <AnimatePresence>
            {showProfile && (
              <>
                ...
                />
                <motion.div
                  className="absolute right-0 top-[calc(100%+8px)] z-20 min-w-[200px] rounded-xl border border-white/80 bg-surface/95 p-1.5 shadow-[0_16px_48px_rgba(39,49,38,0.16)] backdrop-blur-[18px]"
