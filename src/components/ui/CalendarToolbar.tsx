...
export function CalendarToolbar({
  ...
  return (
    <div className="relative mb-6 overflow-hidden rounded-2xl bg-gradient-to-br from-[#f0f4ff] via-white to-[#faf5ff] p-4 shadow-[0_2px_16px_rgba(37,99,235,0.06)]">
      {/* Decorative blobs */}
      ...
      <div className="relative flex items-center justify-between gap-4 max-md:flex-col max-md:items-stretch">
        {/* View switcher */}
        <div className="inline-flex items-center gap-0.5 rounded-xl border border-[#e2e8f0] bg-white/90 p-1 shadow-sm">
          {viewOptions.map((opt) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-1.5 rounded-lg px-3.5 py-2 text-[0.72rem] font-bold whitespace-nowrap transition-all duration-200 ${
                  active
        ...
        <div className="flex items-center gap-2">
          <button
            type="button"
            onClick={onToday}
            className="rounded-lg border border-[#e2e8f0] bg-white/90 px-3.5 py-2 text-[0.72rem] font-bold text-[#475569] transition-all hover:bg-[#f1f5f9] hover:text-primary active:scale-95 shadow-sm"
          >
            Hari Ini
          </button>
          ...
          {onAddEvent && (
            <button
              type="button"
              onClick={onAddEvent}
              className="flex items-center gap-1.5 rounded-lg bg-primary px-3.5 py-2 text-[0.72rem] font-bold text-white transition-all hover:bg-primary-dark active:scale-95 shadow-[0_2px_8px_rgba(37,99,235,0.2)]"
            >
